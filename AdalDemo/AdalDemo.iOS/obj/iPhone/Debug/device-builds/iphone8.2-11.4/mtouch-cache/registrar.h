...
@class Microsoft_Identity_Core_UI_WebviewBase;
@class Microsoft_Identity_Core_UI_SystemWebview_SystemWebUI;
@class AuthenticationAgentUIViewController;
@class Microsoft_Identity_Core_UI_EmbeddedWebview_CoreCustomUrlProtocol_CoreCustomConnectionDelegate;
@class Microsoft_Identity_Core_UI_EmbeddedWebview_CoreCustomUrlProtocol;
@class Microsoft_Identity_Core_UI_EmbeddedWebview_EmbeddedWebUI;
@class Microsoft_Identity_Core_UI_EmbeddedWebview_WKWebNavigationDelegate_WKWebViewUIDelegate;
@class Microsoft_Identity_Core_UI_EmbeddedWebview_WKWebNavigationDelegate;
